...
import { CheckCircle, Shield, Briefcase, ScrollText } from "lucide-react"
...
const steps = [
  {
    ...
    icon: Shield,
    path: "/dashboard/employer/onboarding/step-1",
  },
  {
    id: 2,
    title: "Professional Profile",
    description: "Setup your employer profile",
    icon: Briefcase,
    path: "/dashboard/employer/onboarding/step-2",
  },
  {
    id: 3,
    ...
    icon: ScrollText,
    path: "/dashboard/employer/onboarding/step-3",
  },
]
