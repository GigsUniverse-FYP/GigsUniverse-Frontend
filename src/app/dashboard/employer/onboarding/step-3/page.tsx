...
export default function Step4TermsConditions() {
  ...
  const completeOnboarding = async () => {
    ...
    try {
        const res = await fetch(`${backendUrl}/api/onboarding/employer/onboarded`, {
          method: "POST",
          credentials: "include",
        })
                ...
                <div className="bg-gray-50 rounded-xl p-6 max-h-64 overflow-y-auto">
                  ...
                  <div className="text-sm text-gray-600 space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                        <li>You will provide clear, accurate, and complete job descriptions for posted projects</li>
                        <li>You will treat freelancers with professionalism and respect at all times</li>
                        <li>You will ensure timely communication and respond to project updates or queries</li>
                        <li>You agree to pay for completed work as outlined in the agreed-upon contracts</li>
                        <li>You will comply with applicable laws and labor regulations within your jurisdiction</li>
                        <li>You understand that GigsUniverse charges a service fee on completed transactions</li>
                        <li>You will not engage in fraudulent behavior or misrepresent job opportunities</li>
                    </ul>
                    <p className="mt-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="terms" className="text-sm text-gray-700 leading-5">
                      ...
                      and understand my obligations as a employer on this platform.
                    </label>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Checkbox
