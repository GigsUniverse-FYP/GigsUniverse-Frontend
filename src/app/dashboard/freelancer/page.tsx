...
export default function FreelancerDashboard() {
  ...
  const skillsDonutData = [
    { label: "React", value: 15, color: "black" },
    { label: "UI/UX", value: 12, color: "#6b7280" },
    { label: "Node.js", value: 8, color: "#d1d5db" },
  ]
    ...
    <div className="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-6 sm:mr-0 mr-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 border border-gray-200 shadow-md bg-white rounded-xl">
          ...
          <CardContent>
            <SimpleLineChart data={earningsData} height={200} />
          </CardContent>
        </Card>
        ...
        <Card className="border border-gray-200 shadow-md bg-white rounded-xl">
          <CardHeader className="pb-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-lg font-bold text-gray-900">Skills Distribution</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="flex justify-center">
            <SimpleDonutChart data={skillsDonutData} size={120} />
          </CardContent>
        </Card>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border border-gray-200 shadow-md bg-gray-50 rounded-xl">
            ...
            <CardContent className="space-y-3">
              ...
              >
                <a href="/freelancer/job-search" className="flex items-center justify-center gap-2">
              ...
              >
                <a href="/freelancer/my-jobs" className="flex items-center justify-center gap-2">
              ...
              <Button
                ...
                className="w-full h-10 border border-gray-300 hover:border-black bg-white hover:bg-gray-50 rounded-xl font-semibold transition-all duration-200"
              >
                <a href="/freelancer/chat" className="flex items-center justify-center gap-2">
      ...
      {/* Upcoming Deadlines */}
      <Card className="border border-gray-200 shadow-md bg-white rounded-xl mb-5">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-black rounded-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <h4 className="font-semibold text-gray-900 mb-1 text-sm">{item.project}</h4>
                <p className="text-gray-600 font-medium text-xs">{item.client}</p>
              </div>
            ))}
          </div>
        </CardContent>
