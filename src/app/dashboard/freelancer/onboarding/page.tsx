...
const steps = [
  ...
  {
    id: 3,
    title: "Setup Stripe Express",
    description: "Connect your payment method to receive payments",
    icon: DollarSign,
    color: "black",
  },
  {
...
export default function Onboarding() {
  ...
  const isStepComplete = (stepId: number) => {
    switch (stepId) {
      ...
      case 3:
        return true // Stripe setup would be handled separately
      case 4:
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              ...
              <Button className="w-full mt-6 bg-black hover:black">
