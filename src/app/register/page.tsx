          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 border-2 hover:border-gray-400 bg-white">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-gray-600">
                  Find amazing projects and showcase your skills to potential clients from now on
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/register/freelancer">
                  <Button className="w-full bg-gray-900 hover:bg-gray-800 text-white cursor-pointer">Register as Freelancer</Button>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 border-2 hover:border-gray-400 bg-white">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-gray-600">
                  Get the best talent for your projects and manage your gigs efficiently from now on
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/register/employer">
                  <Button className="w-full bg-gray-900 hover:bg-gray-800 text-white cursor-pointer">Register as Employer</Button>
                </Link>
              </CardContent>
            </Card>
          </div>
