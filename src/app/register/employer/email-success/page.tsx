        ...
        <div className="w-full max-w-md">
          <Card className="border-2 border-gray-300 bg-white shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-600">Your employer account has been activated</CardDescription>
            </CardHeader>
              ...
              <div className="bg-green-50 border border-green-200 rounded-md p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">You can now access all employer features</p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-sm text-gray-600 space-y-3">
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 ml-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <div className="w-1.5 h-1.5 bg-gray-400 rounded-full"></div>
                      <span>Start finding desired talents</span>
                    </li>
                  </ul>
                </div>
              </div>
