...
export default function FreelancerSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`${backendURL}/api/auth/freelancer/register`, {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        } else if (resultText === "Freelancer ID already in use") {
          setErrors({ id: "Freelancer ID is already taken, Please choose another ID." });
        } else {
      ...
      router.push(`/register/freelancer/confirm-email?email=${formData.email}`);
  ...
  const handleGoogleSignup = () => {
    window.location.href = "/register/freelancer/google-setup";
  };
          ...
          <Card className="border-2 border-gray-300 bg-white shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-600">
                Join GigsUniverse and start finding amazing projects
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-md p-3">
                  <p className="text-sm text-amber-800">
                    <strong>Important:</strong> Your ID is unchangeable once it
                    is created. Choose carefully!
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={`border-gray-300 focus:border-gray-500 pr-40 ${
                  ...
                  <p className="text-xs text-gray-500">
                    Your unique ID will be:{" "}
                    <strong>
                      {formData.id || "your-unique-id"}@gigsuniverse.freelancer
                    </strong>
                  </p>
                </div>
              ...
              <div className="mt-6 text-center text-sm text-gray-600">
                ...
                <Link
                  ...
                  className="text-gray-900 hover:text-black font-medium cursor-pointer"
                >
